...
-- `admin/track_visit` records a visit and creates the `visitors` table if missing.
...
- Open in your browser:
  http://localhost/ROIwebsite/admin/simulate_visits
- The script inserts sample visitor rows (5 this week, 3 last week) and returns JSON with inserted keys and the resulting counts.
  -- After running the simulation, open the dashboard to confirm the boxes update: http://localhost/ROIwebsite/admin/dashboard
